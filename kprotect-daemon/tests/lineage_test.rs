...
async fn test_recursive_cleanup() {
    ...
    // Chain: 1 -> 10 -> 20
    cache.insert(1, LineageNode { path: "1".into(), arg: None, ppid: 0, start_time: 1, signature: 1, child_count: 1, is_exited: false });
    cache.insert(10, LineageNode { path: "10".into(), arg: None, ppid: 1, start_time: 10, signature: 10, child_count: 1, is_exited: true });
    cache.insert(20, LineageNode { path: "20".into(), arg: None, ppid: 10, start_time: 20, signature: 20, child_count: 0, is_exited: false });
...
async fn test_concurrency_stress() {
    ...
    for i in 1..101 {
        ...
        tasks.push(tokio::spawn(async move {
            ...
            cache_task.insert(pid, LineageNode {
                path: format!("proc_{}", i),
                arg: None,
                ppid: 1,
                start_time: i as u64,
